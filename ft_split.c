...
/*   Updated: 2021/04/24 18:02:08 by mjammie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

char	**malloc_free(char **arr)
{
	int	i;
...
int	str_line_len(char *str, char c)
{
	int	count;
...
char	**write_lines(char **result, char const *s, int count_strs, char c)
{
	int	n;
	int	str_pos;
	int	c_pos;
